    ...
    return (
        <section>
            ...
            <div className='welcome-information'>
                <img src={walkerImage}/>
                <p><h1>Welcome to Doggy daycare.</h1>When you leave your dog with us you can be sure that you get the best care for your best friend<br /> 
            ...
            <aside className='quotes'>
                <div className='quote'>
                    ...
                    <p>Ludde can be quite picky with who he trusts but after just a few days he was running to the daycare happy to meet his new friends. I can really recommend Doggy Daycare!</p>
                </div>
                <div className='quote'>
